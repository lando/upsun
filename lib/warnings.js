...
const DOCS_CONFIG = 'https://github.com/AaronFeledy/upsun/blob/main/docs/config.md';

exports.unsupportedServices = (services = '') => ({
  title: 'Unsupported Upsun Fixed services detected',
  detail: [
...
exports.unsupportedLanguages = (languages = '') => ({
  title: 'Unsupported Upsun Fixed languages detected',
  detail: [
    'Lando has detected application languages in your Fixed (.platform) config which are not yet supported.',
    'This may result in errors or reduced functionality.',
