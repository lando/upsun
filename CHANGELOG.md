...
* Phase-2.5 offline: pull/push marked **code shipped** on main @ `9bf288b` (not E2E); `examples/drupal8-sync` uses `--upsun-*` flags; user-facing docs titles say Upsun Fixed / `@lando/upsun`. Still needs a live `PLATFORMSH_CLI_TOKEN` before E2E.
...
## v1.0.0-alpha.0 - [September 4, 2026](https://github.com/lando/upsun)
